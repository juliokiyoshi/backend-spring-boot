...
public class ProjectController {
    ...
    @GetMapping("/project")
    public Page<ProjectReturnDto> getProject(@RequestParam(required = true) Integer page,
        ...
        Page<ProjectReturnDto> Projects = ProjectPaged.map(Project -> ProjectReturnDto.fromProject(Project));
    ...
    public ProjectReturnDto getProject(@PathVariable Long id) {

        log.info(String.format("Fetching Project by id : Id : %s", id));

        ProjectReturnDto Project = ProjectReturnDto.fromProject(this.ProjectService.findProjectById(id));
