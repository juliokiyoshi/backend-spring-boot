...
public class ProjectCreationPayloadValidationTests {
    ...
    @Test
    void whenPayloadRequiredFieldsAreMissing_should_Return400AndTheErrors() throws Exception {
        String payload = "{}";
    ...
    @Test
    void whenRequestingProjectCreationWithAProductOwnerThatDoesNotExists_should_Return404Error() throws Exception {
    ...
    @Test
    void whenRequestingProjectCreationWithAScrumMasterThatDoesNotExistsDoes_should_Return404Error() throws Exception {
        this.academyClassRepository.deleteAll();
        this.projectRepository.deleteAll();
        this.employeeRepository.deleteAll();
    ...
    @Test
    void whenRequestingProjectCreationWithAScrumMasterThatWasEqualsToProductOwner_should_Return500Error() throws Exception {
        this.academyClassRepository.deleteAll();
        this.projectRepository.deleteAll();
        this.employeeRepository.deleteAll();
