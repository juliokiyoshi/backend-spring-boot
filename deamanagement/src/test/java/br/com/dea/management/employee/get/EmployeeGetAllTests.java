...
public class EmployeeGetAllTests {
    ...
    void whenRequestingEmployeeList_thenReturnListOfEmployeePaginatedSuccessfully() throws Exception {
        ...
        mockMvc.perform(get("/employee?page=0&pageSize=4"))
                ...
                .andExpect(jsonPath("$.content[0].email", is("0email@gmail.com")))
                ...
                .andExpect(jsonPath("$.content[1].email", is("1email@gmail.com")))
                ...
                .andExpect(jsonPath("$.content[2].email", is("10email@gmail.com")))
                ...
                .andExpect(jsonPath("$.content[3].email", is("11email@gmail.com")))
